...
export const SEED_LEADS: Lead[] = [
  ...
  },
  {
    ...
    vertical: "trades", service: "tedos", stage: "closed-won", source: "partner",
    ...
    tags: ["trades", "closed", "tedos"], notes: "Signed and onboarded. TEDOS deployment for field ops.",
  ...
  // Additional leads for richer map view
  {
    ...
    tags: ["auto", "linkedin"], notes: "Connected on LinkedIn. Liked our sovereign AI post.",
  ...
  },
  {
    ...
    vertical: "trades", service: "tedos", stage: "prospect", source: "website",
...
export const SEED_ACTIVITIES: Activity[] = [
  ...
  { id: "a-002", leadId: "lead-001", type: "meeting", title: "Demo Call — Sovereign AI", description: "45-min demo showing local LLM for legal research. Very positive response.", timestamp: daysAgo(8), automated: false },
  ...
  { id: "a-005", leadId: "lead-002", type: "email-sent", title: "Proposal Sent", description: "Sent Sovereign AI proposal with HIPAA compliance addendum for 3 dental locations.", timestamp: daysAgo(3), automated: false },
  ...
  { id: "a-007", leadId: "lead-003", type: "email-sent", title: "Follow-up: Scheduling Demo", description: "Sent calendar invite for Sovereign AI demo focused on dispatch automation.", timestamp: daysAgo(5), automated: false },
  ...
  { id: "a-015", leadId: "lead-007", type: "document-signed", title: "SOW Signed", description: "TEDOS SOW signed via deal room e-signature.", timestamp: daysAgo(35), automated: false },
...
export const SEED_NURTURE_SEQUENCES: NurtureSequence[] = [
  {
    ...
    steps: [
      { id: "s1", order: 1, type: "email", subject: "Own Your AI — Built for Auto Dealerships", body: "Introduction to TechFides Sovereign AI for auto operations...", completed: true, sentAt: daysAgo(6) },
