...
const socialLinks = [
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/techfides/",
    icon: (
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/TechFidesTX/",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/tech_fides/",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/@Tech_Fides/featured",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-6">
            ...
            <div className="mt-4 flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-700 text-slate-400 transition-colors hover:border-electric-500/50 hover:text-electric-400"
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              {[
                { name: "Overview", href: "/consulting/tedos" },
                { name: "Architecture & Deployment", href: "/consulting/tedos" },
                { name: "Security & Compliance", href: "/consulting/tedos" },
              ].map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-sm text-slate-300 hover:text-electric-400"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              {[
                { name: "AI Assessment", href: "/consulting/ai-readiness-360" },
                { name: "Transformation Management", href: "/consulting/transformation-management" },
                { name: "Solutions by Vertical", href: "/solutions" },
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              {[
                ...
                { name: "Contact", href: "mailto:engage@techfides.com" },
              ].map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
